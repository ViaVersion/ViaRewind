...
public class TrackingCompressionHandlerProvider extends CompressionHandlerProvider {
    ...
    public void setCompressionThreshold(UserConnection user, int threshold) {
        ...
        if (encoder != null) {
            ...
            pipeline.addBefore(Via.getManager().getInjector().getEncoderName(), compressHandlerName, new CompressionEncoder(threshold));
        }
        ...
        if (decoder != null) {
            ...
            pipeline.addBefore(Via.getManager().getInjector().getDecoderName(), decompressHandlerName, new CompressionDecoder(threshold));
        }
    }
