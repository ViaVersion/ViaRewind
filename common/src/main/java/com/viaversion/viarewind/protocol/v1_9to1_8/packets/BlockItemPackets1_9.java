...
import com.viaversion.viarewind.protocol.v1_9to1_8.data.PotionMappings;
...
public class BlockItemPackets1_9 extends VRBlockItemRewriter<ClientboundPackets1_9, ServerboundPackets1_8, Protocol1_9To1_8> {

	public final Set<String> VALID_ATTRIBUTES = new HashSet<>();

	private LegacyEnchantmentRewriter enchantmentRewriter;

	public BlockItemPackets1_9(Protocol1_9To1_8 protocol) {
		super(protocol, "1.9");
